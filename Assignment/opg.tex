...
%The existence of the first system above is just unpacking what (\ref{eq: Last reformulation of initial equations}) is saying. 
...
\begin{proof}
    ...
    % In order to apply (\ref{thm Skolems method}) we need to first of all make sure that $f$ is nonfull and decomposable. 
