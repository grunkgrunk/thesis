...
\begin{proof}[Valuation on Dedekind domains]
    ...
    %Because of (\ref{lem: Image of valuation and completed valuation are the same}) we know that the valuation $\hat v_\mfrak p$ is discrete and normalized if $v_\mfrak p$ is. 
