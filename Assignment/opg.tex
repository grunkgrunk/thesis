...
% To be clear, the vice versa part of this definition is crucial for this to define an equivalence relation. That is, a linear change in variables 
% $x = 3$
% $u + v = 3$
...
% Norm forms are decomposable as they clearly factor into linear factors over $L$.
...
%($F$ is already decomposable since it is nonfull?)
